...
"#;
        ...
        assert!(
            body.contains("mod xtests_3_conformance_limit_detect"),
            "conformance_limit_detect should be renamed"
        );
        assert!(
            body.contains("pub mod xtests_3_x"),
            "pub mod x should be renamed keeping pub"
        );
        assert!(
            !body.contains("mod conformance_limit_detect\n"),
